<x-landing-core::base-layout title="Novo depoimento" body-class="lp-testimonials-admin-page">
    <x-slot:head>
    ...
    <section class="lp-section lp-testimonials-admin">
        <div class="lp-container">
            <header class="lp-section-header">
                ...
                <h1 class="lp-heading">Novo depoimento</h1>
            </header>

            @include('landing-testimonials::admin.form', [
                'testimonial' => $testimonial,
                'action' => route('testimonials.admin.store'),
                'method' => 'POST',
